...
public class BillTypeSpinnerAdapter extends BaseAdapter {
    Context context;
    ...
    public BillTypeSpinnerAdapter(Context context, List<String> listData) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.txtName = convertView.findViewById(R.id.adptr_spnnr_itm_txt_item_billtype);
