...
public class GifView extends View {
    ...
    /**
     * Scaling factor for adjusting overall view size.
     */
    ...
    public void setGifScaleFactor(float mScaleFactor) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (movie != null) {
			 ...
			 */
            mScale = mScaleFactor / Math.max(scaleH, scaleW);
            mMeasuredMovieWidth = (int) (movieWidth * mScale);
            mMeasuredMovieHeight = (int) (movieHeight * mScale);


//            int width = AppConfig.getInstance().scrnWidth;
//            mMeasuredMovieWidth = (int) (width);//(int) 1000;//(movieWidth * mScale);
//            mMeasuredMovieHeight = (int) (width / 0.733);//(int) (movieHeight * mScale);
