...
public class CalendarNextMonthAdapter extends BaseAdapter {
    ...
    public CalendarNextMonthAdapter(Context context, GregorianCalendar monthCalendar, ArrayList<String> lstImportantDates) {
    ...
    public CalendarNextMonthAdapter(Context context, GregorianCalendar monthCalendar, ArrayList<String> lstImportantDates, boolean showCurrent) {
        Locale.setDefault(Locale.US);
        this.mContext = context;
        this.dayString = new ArrayList();
        this.items = new ArrayList();
