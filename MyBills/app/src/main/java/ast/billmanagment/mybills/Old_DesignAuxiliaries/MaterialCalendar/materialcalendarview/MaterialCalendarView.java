...
import ast.billmanagment.mybills.Old_DesignAuxiliaries.MaterialCalendar.materialcalendarview.format.ArrayWeekDayFormatter;
import ast.billmanagment.mybills.Old_DesignAuxiliaries.MaterialCalendar.materialcalendarview.format.DateFormatTitleFormatter;
import ast.billmanagment.mybills.Old_DesignAuxiliaries.MaterialCalendar.materialcalendarview.format.DayFormatter;
import ast.billmanagment.mybills.Old_DesignAuxiliaries.MaterialCalendar.materialcalendarview.format.MonthArrayTitleFormatter;
import ast.billmanagment.mybills.Old_DesignAuxiliaries.MaterialCalendar.materialcalendarview.format.TitleFormatter;
import ast.billmanagment.mybills.Old_DesignAuxiliaries.MaterialCalendar.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        title.setTextColor(context.getResources().getColor(R.color.thm_yellow_1));
        ...
        try {
            ...
            if (firstDayOfWeek < 0) {
                ...
                firstDayOfWeek = Calendar.getInstance(Locale.US).getFirstDayOfWeek();
            }
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.mcv_action_next);
            }
            ...
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.mcv_action_previous);
            }
...
//        title.setTextLocale(Locale.ENGLISH);
...
//        }
    ...
    protected void dispatchOnRangeSelected(final CalendarDay firstDay, final CalendarDay lastDay) {
        ...
        final Calendar counter = Calendar.getInstance(Locale.US);
...
//        onDateClicked(dayView.getDate(), !dayView.isChecked());
    ...
    public class StateBuilder {
        ...
        private int firstDayOfWeek = Calendar.getInstance(Locale.US).getFirstDayOfWeek();
