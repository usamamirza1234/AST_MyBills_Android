...
public class ElectricityInfoRcvAdapter extends RecyclerView.Adapter<ElectricityInfoRcvAdapter.ViewHolder> {
    ...
    public ElectricityInfoRcvAdapter(Context mContext, ArrayList<DModelBillInfo> mData,
    ...
    public ElectricityInfoRcvAdapter(Context mContext, ArrayList<DModelBillInfo> mData, int selectedPosition,
                                     IAdapterCallback iAdapterCallback) {
        this.mContext = mContext;
        this.mData = mData;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void styleViewSection(boolean b, int Position) {
            if (!b) {
                ...
                txv_address.setTextColor(mContext.getResources().getColor(R.color.thm_yellow_1));
                txv_city.setTextColor(mContext.getResources().getColor(R.color.thm_yellow_1));
                txv_bill.setTextColor(mContext.getResources().getColor(R.color.thm_yellow_1));
                txv_view.setTextColor(mContext.getResources().getColor(R.color.black_1));
