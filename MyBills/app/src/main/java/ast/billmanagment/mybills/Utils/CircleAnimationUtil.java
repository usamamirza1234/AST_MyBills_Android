...
public class CircleAnimationUtil {
    ...
    private static final int DEFAULT_DURATION_DISAPPEAR = 500;
    ...
    private CircleStrokeImageView mImageView;
    ...
    private boolean prepare() {
        if (mContextReference.get() != null) {
            ...
            if (mImageView == null)
                mImageView = new CircleStrokeImageView(mContextReference.get());
