...
public class InternetHomeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View frg = inflater.inflate(R.layout.fragment_home_internet, container, false);
    ...
    void setBottomBar() {
        ...
        if (getActivity() != null && isAdded()) {
            ...
            mBadgeUpdateListener.setHeaderTitle("Internet");
