...
public class FeaturedOutletsViewPagerAdapter extends PagerAdapter {
    ...
    public FeaturedOutletsViewPagerAdapter(Context context, ArrayList<DModelBanner> listData, Fragment frg, final IAdapterCallback iAdapterCallback) {
