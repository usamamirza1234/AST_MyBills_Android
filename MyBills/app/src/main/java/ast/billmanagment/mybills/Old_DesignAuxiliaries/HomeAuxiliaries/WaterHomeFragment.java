...
public class WaterHomeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View frg = inflater.inflate(R.layout.fragment_home_water, container, false);
        init();
        bindviews(frg);
    ...
    void setBottomBar() {
        ...
        if (getActivity() != null && isAdded()) {
            ...
            mBadgeUpdateListener.setHeaderTitle("Water");
